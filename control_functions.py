...
def hub_control(graph, balls, step, control_interval=100, control_fraction=0.1, control_balls=50):
    '''
	...
	balls_per_node = control_balls/num_hubs
...
def random_control(graph, balls, step, control_interval=100, control_fraction=0.1, control_balls=50):
    '''
    ...
    # Check if anything is to be done at this step
    if step%control_interval==0:
	balls_per_node = control_balls/num_targets
