...
def hub_control(graph, balls, step, burn_in=5000, control_interval=100, control_fraction=0.1, control_balls=10):
    """
...
def random_control(graph, balls, step, burn_in=5000, control_interval=100, control_fraction=0.1, control_balls=10):
    """
...
def tom_control(graph, balls, step, burn_in=5000, control_interval=100, control_fraction=0.1, control_balls=10):
    """
        Exercises control by periodically targeting a certain fraction of the nodes at random and sending them a fixed number of balls of colour 0.
        :param graph: The graph on which dynamics are being simulated.
        :param balls: The current distribution of balls at nodes.
...
def broadcast_control(graph, balls, step, burn_in=5000,  control_interval=100, control_balls=10):
    """
